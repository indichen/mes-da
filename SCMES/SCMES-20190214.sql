...
/* Created on:     2019/2/14 下午 04:07:29                        */
/*==============================================================*/
...
create table mlo_process_po (
   ...
   production_qty       type_number          null,
...
create table mlo_sap_po (
   ...
   so_qty               type_number          null,
   unit_length          type_length          null,
   so_unit              type_number          null,
   ...
   storage_qty          type_number          null,
   not_storage_qty      type_number          null,
   last_storage_qty     type_number          null,
