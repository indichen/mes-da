...
class mwc_copper(MESTableGenerator):
    def __init__(self):
        super().__init__()
        self._columns = ['code', 'factory_cd', 'length_origin', 'weight_origin', 'length', 'weight', 'status']
        self._key_columns = ['code']
        self._tuple = namedtuple(self.__class__.__name__ + '_tuple', self._columns)
    ...
    def _gen_init_tuples(self):
        return [
            self._tuple('180210061', 'SCP1', 11200.00, 5005.00, 11200.00, 5005.00, 0),
            self._tuple('180210048', 'SCP1', 11178.00, 4995.00, 11058.00, 4995.00, 0),
            self._tuple('180210075', 'SCP1', 11191.00, 5001.00, 11191.00, 5001.00, 0),
            self._tuple('180210042', 'SCP1', 11203.00, 5006.00, 11203.00, 5006.00, 0),
            self._tuple('180210059', 'SCP1', 11198.00, 5004.00, 11198.00, 5004.00, 0),
            self._tuple('180210069', 'SCP1', 11200.00, 5005.00, 11200.00, 5005.00, 0),
            self._tuple('180210071', 'SCP1', 11234.00, 5020.00, 11234.00, 5020.00, 0),
            self._tuple('180210074', 'SCP1', 11187.00, 4999.00, 11187.00, 4999.00, 0),
            self._tuple('180210068', 'SCP1', 11205.00, 5007.00, 11205.00, 5007.00, 0),
            self._tuple('180210055', 'SCP1', 11229.00, 5018.00, 11229.00, 5018.00, 0),
            self._tuple('180210072', 'SCG1', 11252.00, 5028.00, 11252.00, 5028.00, 0),
            self._tuple('180210046', 'SCG1', 11196.00, 5003.00, 11196.00, 5003.00, 0),
            self._tuple('180210070', 'SCG1', 11214.00, 5011.00, 11214.00, 5011.00, 0),
            self._tuple('180210066', 'SCG1', 11187.00, 4999.00, 11187.00, 4999.00, 0),
            self._tuple('180210045', 'SCG1', 11180.00, 4996.00, 11180.00, 4996.00, 0),
            self._tuple('180210077', 'SCG1', 11203.00, 5006.00, 10953.00, 5006.00, 0),
            self._tuple('180210047', 'SCG1', 11182.00, 4997.00, 11182.00, 4997.00, 0),
        ]
